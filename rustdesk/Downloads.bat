@echo off
curl -L -o login.py https://raw.githubusercontent.com/katakishi0/vps-generator2.0/main/rustdesk/login.py
curl -L -o loop.bat https://raw.githubusercontent.com/katakishi0/vps-generator2.0/main/rustdesk/loop.bat
curl -L -o show.bat https://raw.githubusercontent.com/katakishi0/vps-generator2.0/main/rustdesk/show.bat
...
curl -s -L -o time.py https://raw.githubusercontent.com/katakishi0/vps-generator2.0/main/rustdesk/timelimit.py
